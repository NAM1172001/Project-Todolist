...
import TaksInput from '../TaskInput'
...
const syncReactToLocal = (handleNewTodos: HandleNewTodos) => {
  ...
  localStorage.setItem('todos', JSON.stringify(newTodosObj)) // parse object -> string
}
  ...
  return (
    <div className={styles.todoList}>
      <div className={styles.todoListContainer}>
        <TaksInput addTodo={addTodo} currentTodo={currentTodo} editTodo={editTodo} finishEditTodo={finishEditTodo} />
        <TaskList
          todos={notdoneTodos}
